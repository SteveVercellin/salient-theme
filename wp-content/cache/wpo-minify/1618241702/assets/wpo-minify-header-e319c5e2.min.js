...
(function($,document,window){var __=window.wfi18n.__;var sprintf=window.wfi18n.sprintf;if(!window.wordfenceAJAXWatcher){window.wordfenceAJAXWatcher={blockWarningOpen:!1,init:function(){$(document).ajaxError(function(event,jqXHR,ajaxSettings,thrownError){if(wordfenceAJAXWatcher.blockWarningOpen){return}
