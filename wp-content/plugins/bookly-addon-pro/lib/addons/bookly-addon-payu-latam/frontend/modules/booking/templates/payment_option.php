...
<div class="bookly-box bookly-list">
    <label>
        ...
        <span><?php echo Utils\Common::getTranslatedOption( 'bookly_l10n_label_pay_payu_latam' ) ?>
            <?php if ( $show_price ) : ?>
    ...
    <?php if ( is_array( $payment_status ) &&  $payment_status['gateway'] == Payment::TYPE_PAYULATAM && $payment_status['status'] == 'error' ) : ?>
