<?php
namespace Bookly2checkout\Backend\Modules\Appearance\ProxyProviders;

use Bookly\Backend\Modules\Appearance\Proxy;

/**
 * Class Shared
 * @package Bookly2checkout\Backend\Modules\Appearance\ProxyProviders
 */
class Shared extends Proxy\Shared
{
    ...
    {
        Proxy\Pro::renderPaymentGatewaySelector( 'bookly_l10n_label_pay_2checkout', '2Checkout', true );
    }
    ...
    public static function prepareOptions( array $options_to_save, array $options )
    {
        $options_to_save = array_merge( $options_to_save, array_intersect_key( $options, array_flip( array (
            'bookly_l10n_label_pay_2checkout',
