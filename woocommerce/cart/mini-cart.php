		...
		foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
          ...
          if( 'slide_in_click' !== $mini_cart_style ) {
					...
					<?php if ( empty( $product_permalink ) ) : ?>
						<?php echo '<span class="no-permalink">' . $thumbnail . '</span><div class="product-meta"><div class="product-details">' . $default_remove . $product_name; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
					<?php else : ?>
						<?php echo '<a href="'. esc_url( $product_permalink ) .'">' . $thumbnail . '</a>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
            <?php echo '<div class="product-meta"><div class="product-details">'.$default_remove .'<a href="'.esc_url( $product_permalink ). '">'. $product_name .'</a>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
					<?php endif; ?>
