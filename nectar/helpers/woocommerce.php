...
if( !function_exists('nectar_single_product_review_with_average') ) {
	function nectar_single_product_review_with_average($title) {
		...
		if( $count && wc_review_ratings_enabled() && 'off_canvas' === $woo_review_style && function_exists('wc_get_rating_html') ) {
			...
			$nectar_title .= '<a class="nectar-button large regular accent-color regular-button nectar-product-reviews-trigger" href="#" data-color-override="false" data-hover-color-override="false"><span>'.esc_html('Write a Review','salient').'</span></a>';
...
if( !function_exists('nectar_single_product_review_empty') ) {
	function nectar_single_product_review_empty($title) {
		...
		if( wc_review_ratings_enabled() && 'off_canvas' === $woo_review_style ) {
			...
			$nectar_title .= '<a class="nectar-button large regular accent-color regular-button nectar-product-reviews-trigger" href="#" data-color-override="false" data-hover-color-override="false"><span>'.esc_html('Write a Review','salient').'</span></a></div>';
