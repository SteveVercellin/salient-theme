...
if( !class_exists('NectarThemeManager') ) {
  ...
  class NectarThemeManager {
    ...
    public static function setup() {
      ...
      // Theme Skin.
      $theme_skin        = ( isset(self::$options['theme-skin']) ) ? self::$options['theme-skin'] : 'material';
      ...
      // OCM style.
      $theme_ocm_style    = ( isset( self::$options['header-slide-out-widget-area-style'] ) ) ? self::$options['header-slide-out-widget-area-style'] : 'slide-out-from-right';
