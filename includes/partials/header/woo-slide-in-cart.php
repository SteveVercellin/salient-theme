...
if ( $woocommerce && $nav_cart_style === 'slide_in' ) {
	...
	echo '<div class="inner"><div class="header"><h4>'. esc_html('Cart', 'salient') .'</h4><a href="#" class="close-cart"><span class="screen-reader-text">'.esc_html__('Close Cart','salient').'</span>'.$close_markup.'</a></div>';
